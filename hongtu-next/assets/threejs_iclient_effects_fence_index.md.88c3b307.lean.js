import{C as x,c as T,A as w,V as E,d as P,e as m,T as v,R as d,M as _,D as L,a as R}from"./chunks/three.module.f4768b42.js";import{_ as H,B,f as h,h as C,x as D,D as i,z as M,k as A,u as V,N as q}from"./chunks/framework.5deb65a5.js";const k={name:"Map3D",data(){return{mapCenter:[116.390799,39.915876],mapZoom:13,bearing:0,pitch:45}},methods:{createdHandler(e){this.map=e.$map,this.mapboxgl=this.map.mapboxgl,this.mixers=[],this.clock=new x,this.loaderModels()},loaderModels(){const e=[[116.385394,39.92098],[116.38591,39.911632],[116.389942,39.911565],[116.390457,39.908734],[116.392174,39.908733],[116.39226,39.911959],[116.396294,39.911894],[116.395691,39.921438],[116.385394,39.92098]];this.addThreeLayer(e)},addThreeLayer(e){const s=new this.mapboxgl.supermap.ThreeLayer("threeLayer");s.on("initialized",l);let a;const t=this;function l(){const r=s.getThreeRenderer(),o=s.getScene(),y=s.getCamera();a=new T(16777215,.8),a.position.copy(y.position),o.add(a),o.add(new w(16777215));let c=this.getCoordinatesCenter(e),b=this.lngLatToPosition(c),F=e.map(n=>this.lngLatToPosition({lng:n[0],lat:n[1]}).sub(b));const p=t.addFencing(F.map(n=>[n.x,0,n.y]));p.rotation.x=Math.PI/2,p.rotation.y=Math.PI*2.98,s.setPosition(p,[116.390714,39.916535]),o.add(p),r.render(o,y)}s.on("render",function(){a&&a.position.copy(s.renderer.camera.position)}),this.map.addLayer(s)},addFencing(e){const a=[],t=e.reduce((F,p,n)=>{let u=0;if(n>0){let g=new E(...e[n-1]),f=new E(...p);u=g.distanceTo(f)}return F+=u,a.push(F),F},0),l=new P,r=[],o=[];e.forEach((F,p)=>{if(p==0)return;const n=e[p-1];r.push(...n),o.push(a[p-1]/t,0),r.push(...F),o.push(a[p]/t,0),r.push(n[0],n[1]+1500,n[2]),o.push(a[p-1]/t,1),r.push(...F),o.push(a[p]/t,0),r.push(F[0],F[1]+1500,F[2]),o.push(a[p]/t,1),r.push(n[0],n[1]+1500,n[2]),o.push(a[p-1]/t,1)}),l.setAttribute("position",new m(new Float32Array(r),3)),l.setAttribute("uv",new m(new Float32Array(o),2)),l.computeVertexNormals();const y=new v().load("//bitjjj.github.io/hongtu-next/images/wall.png");y.wrapS=d,y.wrapT=d;const c=new _({color:65280,map:y,transparent:!0,opacity:.9,depthWrite:!1,side:L});return new R(l,c)}}},S={style:{height:"500px"},class:"vw-full vh-full"},N={style:{height:"400px"}};function j(e,s,a,t,l,r){const o=B("x-tianditu-layer"),y=B("x-map");return h(),C("div",S,[D("div",N,[i(y,{zoom:l.mapZoom,"onUpdate:zoom":s[0]||(s[0]=c=>l.mapZoom=c),center:l.mapCenter,"onUpdate:center":s[1]||(s[1]=c=>l.mapCenter=c),bearing:l.bearing,"onUpdate:bearing":s[2]||(s[2]=c=>l.bearing=c),pitch:l.pitch,"onUpdate:pitch":s[3]||(s[3]=c=>l.pitch=c),onCreated:r.createdHandler},{default:M(()=>[i(o)]),_:1},8,["zoom","center","bearing","pitch","onCreated"])])])}const z=H(k,[["render",j]]),I=`<template>
...
<\/script>
`,W=D("h1",{id:"电子围栏效果",tabindex:"-1"},[A("电子围栏效果 "),D("a",{class:"header-anchor",href:"#电子围栏效果","aria-label":'Permalink to "电子围栏效果"'},"​")],-1),Z={id:"示例",tabindex:"-1"},U=D("a",{class:"header-anchor",href:"#示例","aria-label":'Permalink to "示例 <play :source-code="DemoSource" />"'},"​",-1),G=q("",2),K=JSON.parse('{"title":"电子围栏效果","description":"","frontmatter":{},"headers":[],"relativePath":"threejs/iclient/effects/fence/index.md"}'),O={name:"threejs/iclient/effects/fence/index.md"},Q=Object.assign(O,{setup(e){return(s,a)=>{const t=B("play");return h(),C("div",null,[W,D("h2",Z,[A("示例 "),i(t,{"source-code":V(I)},null,8,["source-code"]),A(),U]),i(z),G])}}});export{K as __pageData,Q as default};
