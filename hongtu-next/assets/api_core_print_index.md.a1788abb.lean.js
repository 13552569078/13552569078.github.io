...
<\/script>
`,k=m("",4),S={id:"示例",tabindex:"-1"},j=t("a",{class:"header-anchor",href:"#示例","aria-label":'Permalink to "示例 <play :source-code="DemoSource" />"'},"​",-1),P=m("",2),V=JSON.parse('{"title":"地图打印（Print）","description":"","frontmatter":{},"headers":[],"relativePath":"api/core/print/index.md"}'),L={name:"api/core/print/index.md"},R=Object.assign(L,{setup(l){return(s,b)=>{const r=a("play");return o(),u("div",null,[k,t("h2",S,[y("示例 "),p(r,{"source-code":h(v)},null,8,["source-code"]),y(),j]),p(w),P])}}});export{V as __pageData,R as default};
