import{ap as i,c as A,A as d}from"./chunks/three.module.f4768b42.js";import{M as E,O as u}from"./chunks/MTLLoader.72c8e4f6.js";import{_ as h,B as y,f as m,h as B,x as c,D as F,z as f,k as D,u as C,N as g}from"./chunks/framework.5deb65a5.js";const L={name:"Map3D",data(){return{mapCenter:[116.3466,39.8704],mapZoom:15,bearing:0,pitch:45}},methods:{createdHandler(p){this.map=p.$map,this.mapboxgl=this.map.mapboxgl,this.loaderModels()},loaderModels(){new E(new i).load("//bitjjj.github.io/hongtu-next/obj/windmill_2/windmill-fixed.mtl",n=>{n.preload();const a=new u(new i);a.setMaterials(n),a.load("//bitjjj.github.io/hongtu-next/obj/windmill_2/windmill.obj",o=>{o.traverse(function(t){t.isMesh&&t.geometry.computeVertexNormals()});const s=o;s.rotation.x=-Math.PI/2,s.rotation.y=1.4*Math.PI/5,s.scale.multiplyScalar(.5);const e=s.children[0].clone();e.rotation.x=-Math.PI/2,e.rotation.y=1.4*Math.PI/5,e.scale.multiplyScalar(.5),this.addThreeLayer(s,e)},null,null,null,!1)})},addThreeLayer(p,n){const a=new this.mapboxgl.supermap.ThreeLayer("threeLayer");a.on("initialized",e);const o=this;let s;function e(){const t=a.getThreeRenderer(),r=a.getScene(),l=a.getCamera();s=new A(16777215,.8),s.position.copy(l.position),r.add(s),r.add(new d(16777215)),a.setPosition(p,o.mapCenter),a.setPosition(n,o.mapCenter.map(b=>b-=.0015)),p.translateY(300),r.add(p),r.add(n),t.render(r,l)}a.on("render",function(){s&&s.position.copy(a.renderer.camera.position)}),this.map.addLayer(a)}}},j={style:{height:"500px"},class:"vw-full vh-full"},_={style:{height:"400px"}};function x(p,n,a,o,s,e){const t=y("x-tianditu-layer"),r=y("x-map");return m(),B("div",j,[c("div",_,[F(r,{zoom:s.mapZoom,"onUpdate:zoom":n[0]||(n[0]=l=>s.mapZoom=l),center:s.mapCenter,"onUpdate:center":n[1]||(n[1]=l=>s.mapCenter=l),bearing:s.bearing,"onUpdate:bearing":n[2]||(n[2]=l=>s.bearing=l),pitch:s.pitch,"onUpdate:pitch":n[3]||(n[3]=l=>s.pitch=l),onCreated:e.createdHandler},{default:f(()=>[F(t)]),_:1},8,["zoom","center","bearing","pitch","onCreated"])])])}const w=h(L,[["render",x]]),M=`<template>
