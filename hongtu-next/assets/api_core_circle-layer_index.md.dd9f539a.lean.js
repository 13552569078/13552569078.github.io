import{_ as d,B as t,f as r,h as c,D as a,z as u,x as n,k as p,u as b,N as g}from"./chunks/framework.5deb65a5.js";const m={name:"CircleLayerDemo",data(){return{airpotDataSource:[],color:["scalerank",1,"rgb(178,24,43)",2,"rgb(239,138,98)",4,"rgb(253,219,199)",6,"rgb(209,229,240)",8,"rgb(103,169,207)",10,"rgba(33,102,172,0)"],radius:["scalerank",1,10,10,1]}},mounted(){fetch("//bitjjj.github.io/hongtu-next/geojson/ne_10m_airports.geojson").then(s=>s.json()).then(s=>{this.airpotDataSource=s.features.map(l=>({coordinates:l.geometry.coordinates.slice(),properties:l.properties}))})}},h={style:{height:"400px"},class:"vw-full vh-full"};function f(s,l,y,o,e,S){const i=t("x-tianditu-layer"),F=t("x-circle-layer"),D=t("x-map");return r(),c("div",h,[a(D,{zoom:1.5,pitch:20},{default:u(()=>[a(i),a(F,{data:e.airpotDataSource,color:e.color,radius:e.radius,"stroke-width":1,"stroke-opacity":1},null,8,["data","color","radius"])]),_:1})])}const x=d(m,[["render",f]]),E=`<template>
