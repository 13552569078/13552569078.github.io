...
<\/script>
`,k=r("h1",{id:"fbx格式",tabindex:"-1"},[i("FBX格式 "),r("a",{class:"header-anchor",href:"#fbx格式","aria-label":'Permalink to "FBX格式"'},"​")],-1),R={id:"示例",tabindex:"-1"},H=r("a",{class:"header-anchor",href:"#示例","aria-label":'Permalink to "示例 <play :source-code="DemoSource" />"'},"​",-1),S=x("",2),X=JSON.parse('{"title":"FBX格式","description":"","frontmatter":{},"headers":[],"relativePath":"threejs/iclient/models/fbx/index.md"}'),M={name:"threejs/iclient/models/fbx/index.md"},z=Object.assign(M,{setup(o){return(s,a)=>{const l=D("play");return m(),B("div",null,[k,r("h2",R,[i("示例 "),c(l,{"source-code":C(q)},null,8,["source-code"]),i(),H]),c(w),S])}}});export{X as __pageData,z as default};
