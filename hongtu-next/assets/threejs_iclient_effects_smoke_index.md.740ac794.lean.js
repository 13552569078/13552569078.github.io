  ...
  methods: {
    ...
    async loaderModels() {
      ...
      const promiseStar = new Promise(resolve => {
        new THREE.TextureLoader().load('//bitjjj.github.io/hongtu-next/' + 'images/smoke.png', function (texture) {
          resolve(texture)
        })
      })
...
<\/script>
`,j=A("h1",{id:"黑烟效果",tabindex:"-1"},[u("黑烟效果 "),A("a",{class:"header-anchor",href:"#黑烟效果","aria-label":'Permalink to "黑烟效果"'},"​")],-1),O={id:"示例",tabindex:"-1"},N=A("a",{class:"header-anchor",href:"#示例","aria-label":'Permalink to "示例 <play :source-code="DemoSource" />"'},"​",-1),Z=R("",2),J=JSON.parse('{"title":"黑烟效果","description":"","frontmatter":{},"headers":[],"relativePath":"threejs/iclient/effects/smoke/index.md"}'),U={name:"threejs/iclient/effects/smoke/index.md"},$=Object.assign(U,{setup(y){return(p,o)=>{const a=m("play");return E(),h("div",null,[j,A("h2",O,[u("示例 "),b(a,{"source-code":P(V)},null,8,["source-code"]),u(),N]),b(I),Z])}}});export{J as __pageData,$ as default};
