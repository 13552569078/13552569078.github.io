import{_ as d,B as n,f as o,h as p,D as s,z as u,x as a,k as l,u as h,N as m}from"./chunks/framework.5deb65a5.js";const b={name:"ImageLayerDemo",data(){return{url:"//hongluan-ui.github.io/hongtu-next/images/cestc.jpg",coordinates:[[116.3594627380371,39.93632920085673],[116.4228057861328,39.93632920085673],[116.4228057861328,39.89735776851477],[116.3594627380371,39.89735776851477]]}}},g={style:{height:"400px"},class:"vw-full vh-full"};function _(r,c,i,t,e,S){const y=n("x-tianditu-layer"),F=n("x-image-layer"),D=n("x-map");return o(),p("div",g,[s(D,{zoom:12,pitch:40},{default:u(()=>[s(y),s(F,{url:e.url,coordinates:e.coordinates},null,8,["url","coordinates"])]),_:1})])}const x=d(b,[["render",_]]),f=`<template>
...
export default {
  ...
  data() {
    return {
      url: '//hongluan-ui.github.io/hongtu-next/' + 'images/cestc.jpg',
      coordinates: [
