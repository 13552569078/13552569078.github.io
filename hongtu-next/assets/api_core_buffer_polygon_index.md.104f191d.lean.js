...
<\/script>
`,k=s("h1",{id:"多边形缓冲区-bufferpolygonlayer",tabindex:"-1"},[a("多边形缓冲区（BufferPolygonLayer） "),s("a",{class:"header-anchor",href:"#多边形缓冲区-bufferpolygonlayer","aria-label":'Permalink to "多边形缓冲区（BufferPolygonLayer）"'},"​")],-1),P=s("p",null,"支持拖拽改变位置，拖拽改变大小，实时显示面积等功能",-1),S={id:"示例",tabindex:"-1"},z=s("a",{class:"header-anchor",href:"#示例","aria-label":'Permalink to "示例 <play :source-code="DemoSource" />"'},"​",-1),T=g("",2),O={id:"手工模式示例",tabindex:"-1"},j=s("a",{class:"header-anchor",href:"#手工模式示例","aria-label":'Permalink to "手工模式示例 <play :source-code="DemoManualSource" />"'},"​",-1),L=s("ul",null,[s("li",null,"单击地图画点"),s("li",null,"Esc，Del，Backspace键，删除前一个点"),s("li",null,"双击或者Enter结束手工模式"),s("li",null,"手工模式下，polygon数据无效"),s("li",null,"不支持动态改变manual参数值")],-1),R=g("",11),$=JSON.parse('{"title":"多边形缓冲区（BufferPolygonLayer）","description":"","frontmatter":{},"headers":[],"relativePath":"api/core/buffer/polygon/index.md"}'),N={name:"api/core/buffer/polygon/index.md"},w=Object.assign(N,{setup(D){return(F,i)=>{const t=l("play");return c(),y("div",null,[k,P,s("h2",S,[a("示例 "),n(t,{"source-code":d(B)},null,8,["source-code"]),a(),z]),n(_),T,s("h2",O,[a("手工模式示例 "),n(t,{"source-code":d(v)},null,8,["source-code"]),a(),j]),L,n(A),R])}}});export{$ as __pageData,w as default};
