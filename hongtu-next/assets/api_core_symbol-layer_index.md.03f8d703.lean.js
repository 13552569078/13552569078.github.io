...
`,W=`<template>
  <div style="height:400px" class="vw-full vh-full">
    <x-map :zoom="4" :center="[107.5, 37.5]" :glyphs="'//bitjjj.github.io/hongtu-next/' + 'fonts/{range}.pbf'" :sprite="'//bitjjj.github.io/hongtu-next/' + 'sprites/sprite'">
      <x-tianditu-layer :types="['vec']" />
      <x-symbol-layer
        :data="symbolDataSource"
        text-field="label"
...
`,G=`<template>
  <div style="height:400px" class="vw-full vh-full">
    <x-map :zoom="4" :center="[116.678, 31.456]" :glyphs="'//bitjjj.github.io/hongtu-next/' + 'fonts/{range}.pbf'" :sprite="'//bitjjj.github.io/hongtu-next/' + 'sprites/sprite'">
      <x-tianditu-layer :types="['vec']" />
...
`,K=`<template>
  <div style="height:400px" class="vw-full vh-full">
    <x-map :zoom="11" :center="[116.32,39.90]" :glyphs="'//bitjjj.github.io/hongtu-next/' + 'fonts/{range}.pbf'" :sprite="'//bitjjj.github.io/hongtu-next/' + 'sprites/sprite'">
