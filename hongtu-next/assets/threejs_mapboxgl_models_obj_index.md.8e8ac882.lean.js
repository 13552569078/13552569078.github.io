...
<\/script>
`,I=c("h1",{id:"obj格式",tabindex:"-1"},[m("OBJ格式 "),c("a",{class:"header-anchor",href:"#obj格式","aria-label":'Permalink to "OBJ格式"'},"​")],-1),O={id:"示例",tabindex:"-1"},q=c("a",{class:"header-anchor",href:"#示例","aria-label":'Permalink to "示例 <play :source-code="DemoSource" />"'},"​",-1),U=j("",2),Y=JSON.parse('{"title":"OBJ格式","description":"","frontmatter":{},"headers":[],"relativePath":"threejs/mapboxgl/models/obj/index.md"}'),V={name:"threejs/mapboxgl/models/obj/index.md"},W=Object.assign(V,{setup(s){return(a,o)=>{const p=i("play");return d(),A("div",null,[I,c("h2",O,[m("示例 "),F(p,{"source-code":w(k)},null,8,["source-code"]),m(),q]),F(S),U])}}});export{Y as __pageData,W as default};
