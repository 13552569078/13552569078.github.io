...
<\/script>
`,k=r("h1",{id:"常规three对象",tabindex:"-1"},[D("常规Three对象 "),r("a",{class:"header-anchor",href:"#常规three对象","aria-label":'Permalink to "常规Three对象"'},"​")],-1),S={id:"示例",tabindex:"-1"},N=r("a",{class:"header-anchor",href:"#示例","aria-label":'Permalink to "示例 <play :source-code="DemoSource" />"'},"​",-1),V=w("",2),U=JSON.parse('{"title":"常规Three对象","description":"","frontmatter":{},"headers":[],"relativePath":"threejs/iclient/common/index.md"}'),z={name:"threejs/iclient/common/index.md"},I=Object.assign(z,{setup(p){return(a,e)=>{const s=y("play");return b(),A("div",null,[k,r("h2",S,[D("示例 "),t(s,{"source-code":L(q)},null,8,["source-code"]),D(),N]),t(P),V])}}});export{U as __pageData,I as default};
